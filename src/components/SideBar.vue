    ...
    <nav class="flex items-center justify-between bg-FFC288 flex-wrap p-6">
      <div class="flex items-center flex-shrink-0 text-black mr-6">
        <span class="font-semibold text-xl tracking-tight"><img
            src="../components/image/Screenshot_2566-10-21_at_15.33.09-transformed.png" alt="Logo" class="h-10" /></span>
      </div>
      <div class="block lg:hidden">
        <button @click="isOpen = !isOpen"
          ...
          <svg class="fill-current h-3 w-3" :class="{ hidden: isOpen, block: !isOpen }" xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 20 20">
      ...
      <div :class="{ hidden: !isOpen, block: isOpen }" class="w-full flex-grow lg:flex lg:items-center lg:w-auto">
        ...
        <div class="text-sm mx-4">
          <p v-if="authStore.userRole == 'ROLE_ADMIN'" class="text-red-500 font-bold">
            ADMIN
          </p>
          <p v-if="authStore.userRole == 'ROLE_STUDENT'" class="text-blue-500 font-bold">
            STUDENT
          </p>
          <p v-if="authStore.userRole == 'ROLE_ADVISOR'" class="text-green-500 font-bold">
            ADVISOR
          </p>
        </div>
